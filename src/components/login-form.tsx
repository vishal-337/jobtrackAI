      ...
      <div className="min-h-screen flex items-center justify-center">
        <div className="max-w-xs w-full flex flex-col items-center">
          ...
          <div className="mt-5 space-y-5">
            <a href="#" className="text-sm block underline text-muted-foreground text-center">Forgot your password?</a>
            <p className="text-sm text-center">Don&apos;t have an account?
              <a href="#" className="ml-1 underline text-muted-foreground">Create account</a>
            </p>
          </div>
        </div>
      </div>
